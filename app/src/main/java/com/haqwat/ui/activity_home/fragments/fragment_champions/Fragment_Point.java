...
import com.haqwat.databinding.FragmentPointsBinding;
...
public class Fragment_Point extends Fragment implements FragmentPointsView {
    private FragmentPointsBinding binding;
    private List<ChargeModel> chargeModelList;
    private ChargeAdapter adapter;
    private HomeActivity activity;
    private FragmentPointsPresenter presenter;
    private Preferences preferences;
    private UserModel userModel;

    public static Fragment_Point newInstance(){
        return new Fragment_Point();
    }
    @Nullable
    @Override
    ...
    private void initView() {
        ...
        presenter = new FragmentPointsPresenter(this,activity);
