package com.haqwat.ui.activity_contact_us;
...
import com.haqwat.R;
import com.haqwat.databinding.ActivityContactUsBinding;
import com.haqwat.language.Language;
import com.haqwat.models.ContactUsModel;
...
public class ContactUsActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        contactUsModel.setName(userModel.getName());
        contactUsModel.setEmail(userModel.getEmail());
    ...
    private void contactUs() {
        ...
        Api.getService(Tags.base_url)
                .contactUs("Bearer "+userModel.getToken(),lang,contactUsModel.getName(),contactUsModel.getEmail(),contactUsModel.getPhone(),contactUsModel.getMessage())
